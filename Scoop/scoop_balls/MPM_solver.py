...
class MPMSolver:
    def __init__(self,quality,E_,mass,rho,G,P,R,S):
        self.reset_mpm(quality,E_,mass,rho,G,P,R,S)
    def reset_mpm(self,quality,E_,mass,rho,G,P,R,S):
        self.P=P
        self.rho=rho
        self.G=G
        ...
        for i in range(5):
            ...
            if self.isIn(pos):
                if self.R[i]==1:
                    ...
                    good=good+1
        self.maxx=good#max(self.maxx[None],good)
