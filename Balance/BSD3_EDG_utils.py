...
class ReplayBuffer(object):
    def __init__(self, state_dim, action_dim, max_size=int(1e6)):
        ...
        self.reward_3 = np.zeros((max_size, 1))
    ...
    def add(self, state, action, next_state, reward, done, state_2, action_2, next_state_2, reward_2,reward_3, done_2):
        ...
        self.reward_3[self.ptr] = reward_3
    ...
    def sample(self, batch_size):
        ...
        return (
            ...
            torch.FloatTensor(self.reward_3[ind]).to(self.device),
